...
import type { ContentPlanningAnalysisBilling } from '../src/modules/content-planning/content-planning.service.js';
...
test('planning client config exposes the configured analysis charge', () => {
