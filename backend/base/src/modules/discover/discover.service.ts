...
export const discoverService = {
  ...
  listItems(input: Record<string, unknown>) { return discoverRepository.listItems({ categoryId: text(input.categoryId) || undefined }).map(publicItem) },
