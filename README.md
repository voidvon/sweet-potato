...
Verify downloads with [`SHA256SUMS.txt`](https://github.com/voidvon/sweet-potato/releases/download/v0.1.57/SHA256SUMS.txt), then extract the archive and run the binary:
