        ...
        {activeStep === 'step1' ? (
          <>
            ...
            >
              ...
              {isGenerating ? t("生成中...") : isAnalyzing ? t("分析中...") : `${actionLabel}${analysisCreditLabel}`}
            </button>
          </>
        ) : null}
        ...
        {activeStep === 'step2' ? (
          <>
            ...
            >
              ...
              {t("重新识别{{0}}", { "0": analysisCreditLabel })}
            </button>
            <button
              className="video-task-epa-btn video-task-epa-btn-accent"
              disabled={isBusy}
        ...
        {activeStep === 'step3' ? (
          <>
            ...
            <div className="video-task-epa-stepper">
              ...
              <span>{settingsDraft.candidateCount} {t("条")}</span>
              <button
                aria-label={t("增加候选数量")}
                className="video-task-epa-stepper-btn"
            ...
            >
              {isGenerating ? <LoaderCircle className="is-spinning" size={16} /> : null}
              {isGenerating ? t("生成中...") : t("生成脚本{{0}}", { "0": generationCreditLabel })}
            </button>
          </>
        ) : null}
        ...
        {activeStep === 'step4' ? (
          <>
            ...
            >
              ...
              {isGenerating ? t("生成中...") : t("重新生成{{0}}", { "0": generationCreditLabel })}
            </button>
            <button
              className="video-task-epa-btn video-task-epa-btn-accent"
